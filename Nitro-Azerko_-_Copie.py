    ...
    def main(self):  
        ...
        if os.name == "nt":  
            ...
            ctypes.windll.kernel32.SetConsoleTitleW(
                "Nitro Generator / Checker - Made by Anonyme#5014")
        else:  
            print(f'\33]0;Nitro Generator and Checker - Made by anonyme\a',
                  end='', flush=True)  

        banner = r"""Bientôt de nouveaux Services de ANONYME
 ...
 ▒▒   ▓▒█░░ ▒░   ▒ ▒ ░ ▒░▒░▒░ ░ ▒░   ▒ ▒   ██▒▒▒ ░ ▒░   ░  ░░░ ▒░ ░
  ...
  ░   ▒      ░   ░ ░ ░ ░ ░ ▒     ░   ░ ░ ▒ ▒ ░░  ░      ░      ░   
      ░  ░         ░     ░ ░           ░ ░ ░            ░      ░  ░
        ...
        self.slowType("Made by : Anonyme", .02)
        time.sleep(1)  
        ...
        for s in c:  
            ...
            if os.name == "nt":  
                ctypes.windll.kernel32.SetConsoleTitleW(
                    f"Nitro Generator / Checker - {len(valide)} Valide | {invalide} Invalide - Made by anonyme#5014")
                print("")
            else:  
